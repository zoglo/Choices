...
describe('Choices - select one', () => {
  describe('scenarios', () => {
    describe('basic', () => {
      ...
      describe('focusing on container', () => {
        ...
        describe('pressing an alpha-numeric key', () => {
          test('opens the dropdown and the input value', async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.start();
      ...
      describe('selecting choices', () => {
        ...
        test('allows selecting choices from dropdown', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
        ...
        test('does not remove selected choice from dropdown list', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
          await suite.startWithClick();
      ...
      describe('keys for choice', () => {
        test('up/down arrows for selection', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
          await suite.startWithClick();
        ...
        test('page-up/page-down arrows for selection', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
          await suite.startWithClick();
      ...
      describe('searching choices', () => {
        describe('on input', () => {
          describe('searching by label', () => {
            test('displays choices filtered by inputted value', async ({ page }) => {
              const suite = new SelectTestSuit(page, testUrl, testId);
              await suite.startWithClick();
          ...
          describe('no results found', () => {
            test('displays "no results found" prompt', async ({ page }) => {
              const suite = new SelectTestSuit(page, testUrl, testId);
              await suite.startWithClick();
      ...
      describe('disabling', () => {
        describe('on disable', () => {
          test('disables the search input', async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
      ...
      describe('enabling', () => {
        describe('on enable', () => {
          test('enables the search input', async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
            await suite.group.locator('button.disable').click();
    ...
    describe('disabled choice', () => {
      ...
      test('does not change selected choice', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('render choice limit', () => {
      ...
      test('only displays given number of choices in the dropdown', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('search disabled', () => {
      ...
      test('does not display a search input', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('search floor', () => {
      ...
      describe('on input', () => {
        describe('search floor not reached', () => {
          test('displays choices not filtered by inputted value', async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
    ...
    [
      ...
      describe(`Placeholder via ${arg.name}`, () => {
        ...
        describe('when a choice has been selected', () => {
          test('does not display a placeholder', async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
        ...
        describe('when choice list is open', () => {
          if (testId === 'placeholder-via-data-attr') {
            test('does not displays the placeholder choice first', async ({ page }) => {
              const suite = new SelectTestSuit(page, testUrl, testId);
              await suite.startWithClick();
            ...
            test('displays the placeholder choice first', async ({ page }) => {
              const suite = new SelectTestSuit(page, testUrl, testId);
              await suite.startWithClick();
    ...
    describe('remote data', () => {
      ...
      describe('when loading data', () => {
        ...
        test('shows a loading message as a placeholder', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
          await suite.start();
          await suite.expectHiddenDropdown();
      ...
      describe('when data has loaded', () => {
        describe('opening the dropdown', () => {
          test('displays the loaded data', async ({ page }) => {
    ...
    describe('scrolling dropdown', () => {
      ...
      test('shows partial choices list', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('parent/child', () => {
      ...
      describe('selecting "Parent choice 2"', () => {
        test('enables/disables the child Choices instance', async ({ page }) => {
          const suite = new SelectTestSuit(page, testUrl, testId);
          await suite.start();
    ...
    describe('custom properties via config', () => {
      ...
      describe('on input', () => {
        [
          ...
          test(`filters choices - ${country} = ${city}`, async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
    ...
    describe('custom properties via html', () => {
      ...
      describe('on input', () => {
        [
          ...
          test(`filters choices - ${searchText} = ${label}`, async ({ page }) => {
            const suite = new SelectTestSuit(page, testUrl, testId);
            await suite.startWithClick();
    ...
    describe('non-string values', () => {
      ...
      test('displays expected amount of choices in dropdown', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('dynamically setting choice by value', () => {
      ...
      test('selects choice', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
      ...
      test('does not remove choice from dropdown list', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
      ...
      test('updates the value of the original input', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
    ...
    describe('searching by label only', () => {
      ...
      test('gets zero results when searching by value', async ({ page }) => {
        const suite = new SelectTestSuit(page, testUrl, testId);
        await suite.startWithClick();
        await suite.typeText('item2');
